...
Execute all 4 layers. See `explain.details.md` for full templates, python snippets, and output format.
...
<!-- SPLIT: core=explain.core.md details=explain.details.md -->
